...
2. Have the extract version of Alacrity and "Jext Resources.zip" and merge them
	- Copy the "pack.mcmeta" of root of this repo project into the extracted Alacrity
	- Copy the files from Jext Resources.zip into extract Alacrity  (except for pack.mcmeta and pack.png)
...
3. Go inside that merged directory, select all, and zip
	...
	- Take that new resource-pack.zip and overwrite that one at root directory
